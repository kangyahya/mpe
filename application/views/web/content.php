		...
		<div class="row block">
			<div class="main-content col11">
				...
				<div class="rslides_container">
					<ul class="rslides" id="slider">
						<li><img src="<?php echo base_url()?>assets/front/images/1.jpg"/></li>
						<li><img src="<?php echo base_url()?>assets/front/images/2.jpg"/></li>
						<li><img src="<?php echo base_url()?>assets/front/images/3.jpg"/></li>
						<li><img src="<?php echo base_url()?>assets/front/images/4.jpg"/></li>
					</ul>
				</div>
				...
				<article>
					...
					<div class="content">
						<img src="<?php echo base_url()?>assets/front/images/thumb1.jpg"/>
				...
				<article>
					...
					<div class="content">
						<img src="<?php echo base_url()?>assets/front/images/thumb2.jpg"/>
				...
				<article>
					...
					<div class="content">
						<img src="<?php echo base_url()?>assets/front/images/thumb3.jpg"/>
			...
			<div class="sidebar col05">
				...
				<section>
					...
					<div class="content">
						<section>
							<img src="<?php echo base_url()?>assets/front/images/thumb4.jpg"/>
						...
						<section>
							<img src="<?php echo base_url()?>assets/front/images/thumb5.jpg"/>
							<h4><a href="#">This is Just Going To Be Another Test Post</a></h4>
							<p>Nulla facilisi. Ut fringilla. Suspendisse potenti. Nunc feugiat mi a tellus consequat imperdiet. Vestibulum sapien. Proin quam. Etiam ultrices.</p>
						</section>
						<section>
							<img src="<?php echo base_url()?>assets/front/images/thumb6.jpg"/>
