...
<body class="login-page bg-red">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Seleksi Paskibraka</b></a>
        </div>
        <?php if(isset($error)){ echo $error;} ?>
        <div class="card">

            <div class="body">
                <form id="<?php echo site_url('login') ?>" method="POST">
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <a href="forgot-password.html">Panduan Aplikasi SPK Paskibraka</a>
                        </div>
                    </div>
                </form>
            </div>
