                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header  bg-green">
                            <h2>
                                Nilai Samapta Peserta
                            </h2><br>
                            <a href="<?php echo site_url('samapta/add') ?>" class="btn btn-primary">Tambah</a>
                        </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="paradepi">
                                        <div class="table-responsive">
                                            ...
                                            <?php foreach($paradeputri as $data){ ?>
                                                <tr>
                                                    <td>
                                                    <a href="<?php echo site_url('user/edit/$data->idUser')?>"><span class="material-icons">edit</span></a>
                                                    </td>
